        ...
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-center justify-start text-3xl font-extrabold tracking-wide text-gray-800 hover:text-primary transition-colors duration-200 cursor-pointer px-2"
            >
              OrganKart
            </span>
          </div>
...
>
  ...
  fill="none"
  viewBox="0 0 24 24"
  className="w-8 h-8 text-black hover:text-teal-500"
  xmlns="http://www.w3.org/2000/svg"
>
  <path
  ...
  />
  <path
    d="M3 3h2.14a1 1 0 011 .85L6.62 7 8 16l11-1 2-8H6.62"
    stroke="currentColor"
    strokeLinecap="round"
    strokeLinejoin="round"
    strokeWidth="2"
